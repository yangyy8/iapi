        ...
        <el-row align="center"   :gutter="2" class="pr-20">
          ...
          <el-col  :sm="24" :md="12" :lg="6"  class="input-item">
            ...
            <el-col  :sm="24" :md="12" :lg="6"  class="input-item">
                ...
                <el-select v-model="pd.bs"  class="input-input"  placeholder="请选择"  size="small">
                  ...
                  <el-option value="G" label="过境">
                  </el-option>
                </el-select>
              </el-col>
            <el-col  :sm="24" :md="12" :lg="6"  class="input-item">
                <span class="input-text">不通过原因：</span>
                <el-select v-model="pd.dea"  class="input-input" @visible-change="queryNationality"  placeholder="请选择"  size="small">
                  <el-option
                    v-for="item in nation"
                    :key="item.CODE"
                    :label="item.CNAME"
  ...
  <el-row type="flex" >
    ...
    <el-col :span="6">
      <div class="datacenter">
        <div class="dataleft"><font style="font-size:30px;color:#B2CB65;">252</font><br>预报总量</div>
          <div class="dataleft dataline">&nbsp;</div>
          <div class="dataleft"><font style="font-size:30px;color:#FF667D;">200</font><br>校验不通过的数量</div>
      </div>
</el-col>
  <el-col :span="9"></el-col>
  </el-row>
