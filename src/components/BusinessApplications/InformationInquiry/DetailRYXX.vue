  ...
  <div class="">
    <el-form :model="dform" ref="detailsForm">
      ...
      <div v-show="isPnr">
        ...
        <el-row type="flex"  class="t-detail" v-for="(i,ind) in lftList" v-if="box2" :key="'indl'+ind">
        ...
        <el-row type="flex"  class="t-detail" v-for="(i,ind) in msgList" v-if="box3" :key="'indm'+ind">
        ...
        <el-row type="flex"  class="t-detail" v-for="(i,ind) in ssrList" v-if="box4" :key="'inds'+ind">
        ...
        <el-row class="t-detail" v-for="(i,eqn) in eqnList" v-if="box5" :key="eqn">
          <el-col :span="24" class="t-el-content"><div class="t-el-text">分离的人数：</div><div class="t-el-sub">{{i.eqnCount}}</div></el-col>
          <el-row type="flex"  v-for="(j,rci) in i.rciList" style="width:100%" :key="rci">
        ...
        <el-row type="flex"  class="t-detail" v-for="(i,ind) in lftListTwo" v-if="box6" :key="'lft'+ind">
        ...
        <el-row type="flex"  class="t-detail" v-for="(i,ind) in addListTwo" v-if="box7" :key="'add'+ind">
          <el-col :span="6" class="t-el-content"><div class="t-el-text">城市：</div><div class="t-el-sub">{{i.CITY_NAME}}</div></el-col>
          <el-col :span="6" class="t-el-content"><div class="t-el-text">国家：</div><div class="t-el-sub">{{i.COUNTRY_NAME}}</div></el-col>
          <el-col :span="6" class="t-el-content"><div class="t-el-text">街道号和街道名称：</div><div class="t-el-sub">{{i.STREET_AND_NUMBER}}</div></el-col>
        </el-row>
        <div class="hrtitle-child" @click="box8=!box8">常旅客信息<i class="el-icon-d-caret"></i></div>
        <el-row type="flex"  class="t-detail" v-for="(i,ind) in ftiListTwo" v-if="box8" :key="'fti'+ind">
        ...
        <el-row type="flex"  class="t-detail" v-for="(i,ind) in ssrListTwo" v-if="box9" :key="'ssr'+ind">
        ...
        <el-row class="t-detail" v-for="(i,thr) in messageThr" v-if="box10" :key="thr">
          ...
          <el-col style="width:100%" v-for="(j,his) in i.hisGr11List" :key="his">
            <div class="t-detail">
              <el-row>
        ...
        <el-row type="flex"  class="t-detail" v-for="(i,ind) in fopList" v-if="box11" :key="'fop'+ind">
        ...
        <el-row type="flex"  class="t-detail" v-for="(i,ind) in monList" v-if="box12" :key="'mon'+ind">
        ...
        <el-row type="flex"  class="t-detail" v-for="(i,ind) in txdList" v-if="box13" :key="'txd'+ind">
        ...
        <el-row type="flex"  class="t-detail" v-for="(i,ind) in messageFive" v-if="box14" :key="'mes'+ind">
