...
export default {
  data(){
    return{
      ...
      checkListPnr: ['iapiName','GENDER','pnrBirthdayName','pnrNationaName','PNR_PASSPORTNO','PNR_FLTNO','PNR_FLTDATE1','PNR_FLTTYPE'],
      checkItem:[
        {
          ITEMNAME:'iapiName',
          LABEL:'姓名',
        ...
        if(r.success){
          ...
          if(arr.length == 0){
            if(this.bigBase==5){
              ...
              this.checkListPnr = ['iapiName','GENDER','pnrBirthdayName','pnrNationaName','PNR_PASSPORTNO','PNR_FLTNO','PNR_FLTDATE1','PNR_FLTTYPE'];
            }
          }else{
