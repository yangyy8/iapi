    ...
    <div class="middle">
      ...
      <el-table
        ...
        <el-table-column
          ...
          min-width="100">
          <template slot-scope="scope">
            <el-button type="text" class="a-btn" title="详情" icon="el-icon-tickets" name="ryxxcx_pl_detail_iapi" @click="detailsIapi(scope.row)"></el-button>
         </template>
        </el-table-column>
      </el-table>
      ...
      <el-table
        ...
        <el-table-column
          ...
          min-width="100">
          <template slot-scope="scope">
            <el-button type="text" class="a-btn" title="详情" icon="el-icon-tickets" name="ryxxcx_pl_detail_pnr" @click="detailsPnr(scope.row)"></el-button>
         </template>
        </el-table-column>
      </el-table>
