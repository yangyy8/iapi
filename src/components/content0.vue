    ...
    <el-container class="main">
      <el-aside :width="sideWidth" class="left">
        <el-menu  class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" @select="handleSelect" :collapse="isCollapse">
          <el-submenu :index="index+''" v-for="(i,index) in nav1List" >
            <template slot="title">
              <div class="menu1" :class="{'nav1-checked':nav1Id==i.SERIAL}" @mouseover="nav1to2(i.SERIAL,1)">
              ...
              <!-- <i class="el-icon-location" @click="nav1to2(i.SERIAL,1)"></i> -->
              <!-- <span slot="title">{{i.name}}</span> -->
            </template>
            <el-menu-item-group >
              <el-menu-item :class="{'tc-b':nav2Id==x.SERIAL}" :index="index+''+ind2" v-for="(x,ind2) in nav2List" @click="nav2(x.SERIAL)">{{x.name}}</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
        </el-menu>
        <!-- <ul class="nav1">
          ...
          <li class="nav1-item " :class="{'nav1-checked':nav1Id==i.SERIAL}" v-for="(i,index) in nav1List" @click="nav2Show=true;nav1to2(i.SERIAL,1)">
        ...
        <ul class="nav2-2" v-if="nav2Show">
          <li class="nav2-2-item hand" :class="{'nav2-checked':nav2Id==x.SERIAL}" v-for="x in nav2List" @click="nav2(x.SERIAL)">
            {{x.name}}
          </li>
        </ul> -->
...
export default {
  ...
  methods: {
      ...
      for(var i=0;i<this.nav1List.length;i++){
        ...
        if(a.SERIAL==nav1Id){
          ...
          if(click==1){
            ...
            _this.nav2(_this.nav2Id,nav1Id)
    ...
    // 点击二级菜单======================================
    nav2(nav2Id,nav1Id) {
      this.nav1Id=this.$route.query.nav1Id||nav1Id;
      this.nav2Id = nav2Id;
...
.menu1{
  width: 100%;
  height: 100%;
  background-color: rgba(12, 74, 147,0.8);
  border-radius: 6px;
  display: flex;
  justify-content: center;
  flex-direction: column;
