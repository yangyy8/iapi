    ...
    <el-main class="home-main">
      ...
      <div class="nav-right">
        <svg xmlns="http://www.w3.org/2000/svg" class="svg-nav" data-name="d" viewBox="0 0 178 422.26">
          <path class="cls-1" d="M51.5,142.19a131.62,131.62,0,0,0-50.24-47L50.57.2A239.16,239.16,0,0,1,143,86.68Z" transform="translate(0 -0.2)" fill="#032552"/>
          <path class="cls-1" d="M178,210H71a130.43,130.43,0,0,0-18.46-66.1L144,88.39A236.89,236.89,0,0,1,178,210Z" transform="translate(0 -0.2)" fill="#032552"/>
