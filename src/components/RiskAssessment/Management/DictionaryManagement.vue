<template lang="html">
  <div class="zlbg">
    ...
    <div class="middle" @mouseover="mouseHeader">
      <el-row class="mb-15">
        <el-button type="primary" id="DictionaryManagement_add" size="small" @click="adds(0,'');form={};">新增</el-button>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
              <el-button id="DictionaryManagement_edit" type="text" class="a-btn" title="编辑"  icon="el-icon-edit" @click="adds(1,scope.row)"></el-button>
