<template lang="html">
  <div class="bjsjck">
          ...
          <div class="middle">
            <div class="boder1 pb-10"  ref="box0">
              <el-row :gutter="10">
                <el-col :span="3">
                  <div class="bjsj-l2">
                    <img :src="imgURL" alt="" style="height:150px;" @click="photoDetail">
                    <span >综合风险等级</span>
              ...
              <div v-if="box9">
                <el-table
                  ...
                  <el-table-column
                    ...
                    prop="cert_no">
                    <template slot-scope="scope">
                      <span class="tc-b hand" @click="moreFn('box9',scope.row,(new Date()).getTime())">{{scope.row.cert_no}}</span>
                    </template>
                  </el-table-column>
                  <el-table-column
                    :show-overflow-tooltip="true"
              ...
              <div v-if="box12">
                <el-table
                  ...
                  <el-table-column
                    ...
                    prop="case_name">
                    <template slot-scope="scope">
                      <span class="tc-b hand" @click="moreFn('box12',scope.row,(new Date()).getTime())">{{scope.row.case_name}}</span>
                    </template>
                  </el-table-column>
                  <el-table-column
                    :show-overflow-tooltip="true"
    ...
    <el-dialog title="照片详情" :visible.sync="photoDialogVisible" width="800px">
      <!-- <div class=""> -->
        <div class="photoCon">
...
export default {
  ...
  methods:{
    ...
    photoDetail(){
      ...
      let p={}
      if(this.data0.NATIONALITY=="CHN"){
        p={
          "type": 'img',
          "nationality": this.data0.NATIONALITY,
          "passportno": this.data0.PASSPORTNO,
        ...
        p={
          "passportno": this.data0.PASSPORTNO,
          "nationality": this.data0.NATIONALITY,
          "birthday": this.data0.BIRTHDAY,
          "name": this.data0.NAME,
          "gender":this.data0.GENDER_NAME=="男"?'1':this.data0.GENDER_NAME=="女"?'2':'0',
          "type": 'img',
          "personId":this.personId
        }
      }
      this.$api.post('/manage-platform/riskRecordController/getPhotoListInfo',p,
       r => {
         if(r.success){
           // this.photosList=this.dataceshi
           console.log(r.hasOwnProperty('data'))
         ...
         switch (type) {
           ...
           case 'immcard':
             if(r.data.data.immcard){
               this.countryType=r.data.data.country
    ...
    exportFn(type){
      ...
      let p={
        ...
        "passportno":this.passportno,
        "type":type,
        "sfzh":(type==0||type==4||type==19||type==20||type==21)?this.idcard:''
      }
  ...
  watch:{
    // data0:function(val){
    //   console.log('this.data0.NAME',val)
    //   if(this.data0.NAME||this.data0.NATIONALITY_NAME||this.data0.GENDER_NAME||this.data0.PASSPORTNO){
    //     console.log('this.data0.NAME',val)
    //     this.getRecordOtherInfo('immcard');
    //   }
    // },
