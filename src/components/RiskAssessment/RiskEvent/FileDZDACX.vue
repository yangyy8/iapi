      ...
      <div class="">
        <el-table
          ...
          <el-table-column
            ...
            width="80">
            <template slot-scope="scope">
              <el-button type="text" class="a-btn" icon="el-icon-view" title="查看" @click="$router.push({name:'DZDA',query:{gender:scope.row.GENDER,ename:scope.row.ENAME,birth:scope.row.BIRTHDAY,nationality:scope.row.NATIONALITY,passportno:scope.row.PASSPORTNO,nav2Id:scope.row.PASSPORTNO+scope.row.NATIONALITY,title:scope.row.NAME+'电子档案'}})"></el-button>
