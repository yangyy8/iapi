                ...
                <template slot="description">
                  <div class="" style="backgroundColor:#eee;padding: 3px;box-sizing: border-box;margin-top: -12px;border-radius: 3px;margin-bottom:10px">
                    ...
                    <div class="fz14">
                      ...
                      <span> | 处理人：{{item.tgt_oper}}</span>
                      <span> | 处理部门：{{item.tgt_dept}}</span>
                    </div>
    ...
    <div class="" v-if="moreType=='box12'">
      <div class="ak-tab">
        <div class="ak-tabs">
          ...
          <div class="ak-tab-item hand" :class="{'ak-checked':desctype==1}" @click="desctype=1;descMeth12()">
            案事件和处理结果
          </div>
          <div class="ak-tab-item hand" :class="{'ak-checked':desctype==2}" @click="desctype=2;descMeth12()">
            出入境管理案事件人员证件
          </div>
        </div>
      </div>
      <div class="ak-tab-pane pt-10" @mouseover="mouseHeader">
        ...
        <div class="" v-show="desctype==0">
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <span class="tc-b hand" @click="mmdescTypeOne=!mmdescTypeOne">{{scope.row.case_reg_dt}}</span>
              </template>
            </el-table-column>
            <el-table-column
              :show-overflow-tooltip="true"
              ...
              prop="cas_src_flag">
              <template slot-scope="scope">
                {{scope.row.cas_src_flag==1?'出入境':'边检'}}
              </template>
            </el-table-column>
            <el-table-column
              :show-overflow-tooltip="true"
          ...
          <el-row style="line-height:32px;" v-show="mmdescTypeOne">
            <div class="tt-descBtn">
              <el-button type="primary" size="small" @click="mmdescTypeOne=!mmdescTypeOne">返回</el-button>
            </div>
            <el-col :span="12">
              上报省份：{{moreData.rpt_prov_na||'-'}}
            </el-col>
            <el-col :span="12">
              涉案（事）件角色：{{(moreData.cas_roles_code==1?'主体':moreData.cas_roles_code==2?'被害人':'其它')||'-'}}
            </el-col>
            <el-col :span="12">
              侵害人：{{moreData.infringer_na||'-'}}
            </el-col>
            <el-col :span="12">
              被侵害对象类型：{{moreData.infringed_type_na||'-'}}
            </el-col>
            <el-col :span="12">
              侵害对象：{{moreData.infringer_na||'-'}}
            </el-col>
            <el-col :span="12">
              人身伤害程度：{{moreData.pers_inj_deg||'-'}}
            </el-col>
            <el-col :span="12">
              英文姓名：{{moreData.eng_name||'-'}}
            </el-col>
            ...
            <el-col :span="12">
              当前工作身份：{{moreData.curr_work_id_na||'-'}}
            </el-col>
            <el-col :span="12">
              国家地区：{{moreData.country_na||'-'}}
            </el-col>
            <el-col :span="12">
              户口所在地区：{{moreData.rsdt_region_na||'-'}}
            </el-col>
            <el-col :span="12">
              身份证号码：{{moreData.pers_card_id||'-'}}
            </el-col>
            <el-col :span="12">
              现住地：{{moreData.curr_address||'-'}}
            </el-col>
            <el-col :span="12">
              居住地派出所代码：{{moreData.curr_lps_code||'-'}}
            </el-col>
            <el-col :span="12">
              联系电话：{{moreData.contact_tel||'-'}}
            </el-col>
            <el-col :span="12">
              服务处所组织机构：{{moreData.srv_unit_org||'-'}}
            </el-col>
            <el-col :span="12">
              服务处所：{{moreData.srv_unit_name||'-'}}
            </el-col>
            <el-col :span="12">
              单位联系电话：{{moreData.srv_unit_tel||'-'}}
            </el-col>
            <el-col :span="12">
              邀请单位：{{moreData.invt_unit_code||'-'}}
            </el-col>
            <el-col :span="12">
              备注：{{moreData.remakrs||'-'}}
            </el-col>
            <el-col :span="12">
              通知使领馆全称：{{moreData.note_embassy_name||'-'}}
            </el-col>
            <el-col :span="12">
              通知使领馆时间：{{moreData.note_embassy_date||'-'}}
            </el-col>
            <el-col :span="12">
              登记日期：{{moreData.reg_date||'-'}}
            </el-col>
            <el-col :span="12">
              案件名：{{moreData.case_name||'-'}}
            </el-col>
            <el-col :span="12">
              姓名：{{moreData.pers_name||'-'}}
            </el-col>
            <el-col :span="12">
              立（受）案时间：{{moreData.case_reg_dt||'-'}}
            </el-col>
            <el-col :span="12">
              案件数据来源：{{(moreData.cas_src_flag==1?'出入境':'边检')||'-'}}
            </el-col>
            <el-col :span="12">
              案件承办单位：{{moreData.cntr_unit_name||'-'}}
            </el-col>
            <el-col :span="12">
              涉案人数：{{moreData.per_count||'-'}}
            </el-col>
          </el-row>
        </div>
        ...
        <div class="" v-show="desctype==1">
          <el-row style="line-height:32px;">
            <el-col :span="12">
              案件名称：{{descData12.case_name||'-'}}
            </el-col>
            <el-col :span="12">
              案事件类型：{{descData12.case_nature_na||'-'}}
            </el-col>
            <el-col :span="12">
              案事件类别：{{descData12.case_type_na||'-'}}
            </el-col>
            <el-col :span="12">
              被侵害对象类别：{{descData12.infringe_rlat_na||'-'}}
            </el-col>
            <el-col :span="12">
              案发地区：{{descData12.cas_reg_code_na||'-'}}
            </el-col>
            <el-col :span="12">
              立（受）案时间：{{descData12.case_reg_dt||'-'}}
            </el-col>
            <el-col :span="12">
              对外说辞：{{descData12.extr_words||'-'}}
            </el-col>
            <el-col :span="12">
              案发具体位置：{{descData12.cas_loc||'-'}}
            </el-col>
            <el-col :span="24">
              承办单位名称：{{descData12.cntr_unit_name||'-'}}
            </el-col>
            <el-col :span="24">
          ...
          <div class="stepContent" v-for="(j,key) in descStep12" style="margin-bottom:20px;" :key="key">
           <div style="color:#409EFF" @click="j.bon=!j.bon" class='hand'>{{j.year}}年<i :class="j.bon?'el-icon-caret-bottom':'el-icon-caret-right'"></i></div>
            <el-steps direction="vertical" :active="1" :style="{height:60*j.message.length+'px'}" style="margin-left: 47px;margin-top: 10px;" v-if="j.bon">
              <el-step title="" v-for="(item,ind) in j.message" :key="ind">
                <template slot="description">
                  <div class="" style="backgroundColor:#eee;padding: 3px;box-sizing: border-box;margin-top: -12px;border-radius: 3px;">
                    <div class="fz14">
                      ...
                      <span> | 裁决日期：{{item.adjd_date}}</span>
                      <span> | 案事件类别：{{item.cas_type_na}}</span>
                      <span> | 案件承办单位：{{item.cas_cntr_unit}}</span>
                    </div>
                    <div class="fz14" style="color:#000">
        ...
        <div class="" v-show="desctype==2">
          ...
          <el-row style="line-height:32px;" v-show="mmdescTypeTwo">
            <div class="tt-descBtn">
            ...
            <el-col :span="12">
              英文姓名：{{mmDate_12.eng_name||'-'}}
            </el-col>
            <el-col :span="12">
              中文姓名：{{mmDate_12.chn_name||'-'}}
            </el-col>
            <el-col :span="12">
              性别：{{mmDate_12.gender_na||'-'}}
            </el-col>
            <el-col :span="12">
              出生日期：{{mmDate_12.birth_date||'-'}}
            </el-col>
            <el-col :span="12">
              身份证号码：{{mmDate_12.pers_card_id||'-'}}
            </el-col>
            <el-col :span="12">
              国籍：{{mmDate_12.country_na||'-'}}
            </el-col>
            <el-col :span="12">
              证件种类：{{mmDate_12.cert_type_na||'-'}}
            </el-col>
            <el-col :span="12">
              证件号码：{{mmDate_12.cert_no||'-'}}
            </el-col>
            <el-col :span="12">
              证件有效期至：{{mmDate_12.cert_vld||'-'}}
            </el-col>
            <el-col :span="12">
              本次入境证件标识：{{mmDate_12.curr_entry_cert_flag||'-'}}
            </el-col>
            <el-col :span="12">
              居留事由：{{mmDate_12.rsdt_rsn_na||'-'}}
            </el-col>
            <el-col :span="12">
              签证种类：{{mmDate_12.visa_type_na||'-'}}
            </el-col>
            <el-col :span="12">
              居留证许可号码：{{mmDate_12.prmt_no||'-'}}
            </el-col>
            <el-col :span="12">
              居留许可发证日期：{{mmDate_12.prmt_issuing_date||'-'}}
            </el-col>
            <el-col :span="12">
              居留许可有效期至：{{mmDate_12.prmt_vld||'-'}}
            </el-col>
            <el-col :span="12">
              停留期限：{{mmDate_12.period||'-'}}
            </el-col>
            <el-col :span="12">
              签发机关：{{mmDate_12.issuing_organ_na||'-'}}
            </el-col>
            <el-col :span="12">
              入境口岸：{{mmDate_12.entry_port_na||'-'}}
            </el-col>
            <el-col :span="12">
              入境日期：{{mmDate_12.entry_date||'-'}}
            </el-col>
            <el-col :span="12">
              签证注销单位：{{mmDate_12.visa_cancel_unit_na||'-'}}
            </el-col>
            <el-col :span="12">
              签证注销人：{{mmDate_12.visa_canceler||'-'}}
            </el-col>
            <el-col :span="12">
    ...
    descMeth12(){
      if(this.desctype==1){
        ...
        this.$api.post('/manage-platform/riskRecordExtInterfaceController/getRecordWFWGEventInfo',p,
          r =>{
            if(r.success){
              if(r.data.data.dcap_f_evt_fgn_case.length!=0){
                let lasted = r.data.data.dcap_f_evt_fgn_case[0].message
                this.descData12 = lasted[lasted.length-1];
                this.descStep12 = r.data.data.dcap_f_evt_fgn_case
              }else{
                this.descData12={};
                this.descStep12=[];
              }
    ...
    descMeth(){
      if(this.desctype==1){
        ...
        this.$api.post('/manage-platform/riskRecordExtInterfaceController/getRecordWFWGEventInfo',p,
          r =>{
            if(r.success){
              if(r.data.data.dcap_f_evt_opinion.length!=0){
                let lasted = r.data.data.dcap_f_evt_opinion[0].message;
                this.descData = lasted[lasted.length-1];
                this.descStep = r.data.data.dcap_f_evt_opinion;
              }else{
                this.descData={};
                this.descStep=[];
              }
        ...
        this.$api.post('/manage-platform/riskRecordExtInterfaceController/getRecordWFWGEventInfo',p,
          r =>{
            if(r.success){
              this.certData_1 = r.data.data.illcert;
            }
          })
          let pl={
            "objectId":this.moreData.evt_id,
