        ...
        <div class="middle">
          <div class="co-tab mb-20">
            <div class="co-tabs">
              ...
              <div class="" style="margin-bottom: -6px;width: 80%;" v-show="controlChecked==1&&coCheckId==2">
            ...
            <div class="co-tab-pane" @mouseover="mouseHeader">
              ...
              <div v-if="(controlChecked==1) && (coCheckId==2)">
                <el-row type="flex" justify="end" v-if="isRefreshZH">
                  ...
                  <el-table
                    ...
                    <el-table-column
                      ...
                      sortable>
                      <template  slot-scope="scope">
                        <span>{{scope.row.intgStatus|statusZh}}</span>
                      </template>
                    </el-table-column>
                  </el-table>
