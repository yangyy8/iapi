      ...
      <el-form :model="form" ref="addForm">
        ...
        <el-row type="flex"  class="mb-6">
          <el-col :span="24" class="input-item">
            ...
            <el-select v-model="form.STATUS" clearable placeholder="请选择" size="small" class="width-input" v-verify.change.blur ="{regs:'required',submit:'demo2'}">
               <el-option value="1" label="部门1"></el-option>
               <el-option value="2" label="部门2"></el-option>
               <el-option value="3" label="部门3"></el-option>
               <el-option value="4" label="部门4"></el-option>
             </el-select>
          </el-col>
        </el-row>
