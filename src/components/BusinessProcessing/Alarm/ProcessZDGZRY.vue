        ...
        <el-col :span="12">
          <el-row align="center"  :gutter="2" type="flex" justify="space-between">
            <el-col  :sm="24" :md="12" :lg="10"  class="input-item">
              ...
              <el-select v-model="pd.pnrType" placeholder="请选择" filterable clearable size="small" class="input-input">
               <el-option value="1" label="1 - 风评高风险人员"></el-option>
               <el-option value="2" label="2 - 特殊关注对象"></el-option>
               <el-option value="3" label="3 - IAPI人员预警"></el-option>
              </el-select>
            </el-col>
            <el-col  :sm="24" :md="12" :lg="10"  class="input-item">
