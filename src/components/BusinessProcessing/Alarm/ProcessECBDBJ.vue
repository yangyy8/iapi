    ...
    <div class="middle" @mouseover="mouseHeader">
      ...
      <el-table
        ...
        <el-table-column
          ...
          width="70">
          <template slot-scope="scope">
            <el-button type="text" class="a-btn" icon="el-icon-edit-outline" title="报警处理" name="gzrybjcl_alarm_process" @click="$router.push({name:'alarmProcess',query:{eventserial:scope.row.eventSerial,AlarmType:scope.row.alarmTypeNum}})"></el-button>
