  ...
  <div class="zlbg">
        ...
        <el-col :span="22" class="br pr-20">
          ...
          <el-row align="center" :gutter="2">
            ...
            <el-col :sm="24" :md="12" :lg="8" class="input-item">
              ...
              <el-select placeholder="请选择" v-model="pd.continentsCodeEqual" filterable clearable   size="small"  class="input-input">
                <el-option
            ...
            <el-col :sm="24" :md="12" :lg="8" class="input-item">
              ...
              <el-select placeholder="请选择" v-model="pd.nationalityEqual" filterable clearable size="small"  class="input-input">
                <el-option
    ...
    <el-dialog :title="dialogText" :visible.sync="addDialogVisible" width="500px" >
      <el-form :model="form" ref="addForm">
        ...
        <el-row type="flex"  class="mb-6">
          <el-col :span="24" class="input-item">
            <span class="yy-input-text"><font class="yy-color">*</font>出发地：</span>
        ...
        <el-row type="flex" class="mb-6" >
          <el-col :span="24" class="input-item">
            <span class="yy-input-text"><font class="yy-color">*</font>目的地：</span>
            <el-select v-model="form.DEPT_ID"  filterable clearable placeholder="请选择" size="small" class="yy-input-input" @visible-change="queryNationality">
               <el-option
                 v-for="item in company"
                 :key="item.SERIAL"
